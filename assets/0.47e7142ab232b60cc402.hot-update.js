...
$(document).ready(function () {
    ...
    $('.choice-button').click(function (event) {
        ...
        if (id) {
            ...
            $('.colections-content-inner:visible, .contacts-page-content-inner:visible').removeClass('visible');
            $('.colections-content, .contacts-page-content').find('#' + id).addClass('visible');
        }
    });
});
